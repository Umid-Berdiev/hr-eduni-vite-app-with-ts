<script setup>
  ...
  import { iconsList } from "./data-fontawesome";
  ...
  onMounted(() => {
    ...
    document.getElementById("solid").innerHTML = solid.value;
    document.getElementById("brand").innerHTML = brand.value;
    document.getElementById("regular").innerHTML = regular.value;
  });
</script>
