                    ...
                    <div class="flex-grow-1">
                      <div>
                        ...
                        >
                          ...
                          />
                          <img
                            src="/src/assets/images/small/img-5.jpg"
                            alt=""
                            class="img-fluid rounded"
                            width="60"
                          />
                  ...
                  <div class="d-flex">
                    ...
                    <div class="flex-grow-1">
                      <div>
                        ...
                        <button
                          type="button"
                          class="btn btn-primary btn-rounded waves-effect waves-light mt-4"
                        >
                          See more detail
                        </button>
                      </div>
                  ...
                  <div class="d-flex">
                    ...
                    <div class="flex-grow-1">
                      <div>
                        ...
                        <p class="text-muted mb-0">
                          Suspendisse tempor porttitor elit non maximus. Sed
                          suscipit, purus in convallis condimentum, risus ex
                          pellentesque sapien, vel tempor arcu dolor ut est. Nam
                          ac felis id mauris fermentum nisl pharetra auctor.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="swiper-slide event-list">
                      <div>
                        ...
                        <div class="event-down-icon">
                          <i
                            class="bx bx-down-arrow-circle h3 text-primary down-arrow-icon"
                          ></i>
                        </div>
