              ...
              <div class="card bg-light overflow-hidden">
                <div class="card-body">
                  ...
                  <p class="faq-ans text-muted mt-2 mb-0">
                    ...
                    normal they distribution of letters content here.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="col-xl-4">
              <div class="card bg-light overflow-hidden">
                <div class="card-body">
                  ...
                  <p class="faq-ans text-muted mt-2 mb-0">
                    If several languages coalesce, the grammar resulting
                    language is more simple and regular than individual
                    languages.
                  </p>
                </div>
              </div>
