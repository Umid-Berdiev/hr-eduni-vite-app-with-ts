      ...
      <div class="card">
        <div class="card-body">
          <div class="invoice-title">
            ...
            <div class="mb-4">
              <img
                src="/src/assets/images/logo-dark-sm.png"
                alt="logo"
                height="28"
              />
            </div>
            <div class="text-muted">
              ...
              <p class="mb-1">
                <i class="mdi mdi-email-outline me-1"></i> xyz@987.com
              </p>
            ...
            <div class="table-responsive">
              ...
              >
                ...
                <tbody>
                  ...
                  <!-- end tr -->
                  <tr>
                    <th scope="row" colspan="4" class="text-end fw-bold">
                      Sub Total
                    </th>
                  ...
                  <tr>
                    <th
                      scope="row"
                      colspan="4"
                      class="border-0 text-end fw-bold"
                    >
                      Discount :
                    </th>
