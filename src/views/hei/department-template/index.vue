<script setup>
  ...
  async function postGetDetails() {
    await axios
      .post("https://api.bepay.uz/api/v1/app/create-comments", {
        name: nameFaculty,
  ...
  function getPostDetails(current) {
    axios
      .get(
        `https://api.bepay.uz/api/v1/app/comments-list?page=${current}&lang=ru`
      )
      .then((response) => {
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <a-form @submit.prevent="postGetDetails">
              ...
              <div class="mb-3">
                <label for="kafedra-kod-input" class="form-label">Kod</label>
