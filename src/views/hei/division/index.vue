        ...
        <div class="panel-header">
          ...
          <div class="panel-toggles">
            <div>
              ...
              >
                <i class="fa-solid fa-plus me-2"></i>Bo'lim yaratish
              </button>
            </div>
            <div class="filterBlock">
              <button v-b-toggle.collapse-3 class="btns c-filter py-1.5 px-4">
                <i class="fa-solid fa-filter me-2"></i> <span>Filtr</span>
              </button>
            </div>
          </div>
        </div>
        ...
        <b-card>
          <div class="row">
            <div class="my-2 col-xl-5 form--item">
              ...
              <label for="yu">Bo'linma turi</label>
            </div>
            <div class="my-2 col-xl-5 form--item">
              <a-input id="yu" class="form-control" />
              <label for="yu">Bo'lim nomi bo'yicha qidirish</label>
            </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header bg-card-header">
            <h5 class="modal-title" id="myModalLabel">Bo'lim yaratish</h5>
            ...
            <a-form>
              ...
              <div class="mb-1">
                ...
                <a-input
                  ...
                  placeholder="Bo'linma nomini kiriting"
                />
              </div>
              <div class="mb-3">
                ...
                <a-input
                  ...
                  placeholder="Bo'linma kodini kiriting"
                />
              </div>
...
<style lang="scss">
  ...
  .divisionPage {
    .table-row-division {
      ...
      width: 100% !important;
      grid-gap: 0;
      grid-template-columns: 50px 40px 90px auto 200px 80px 60px;
      @include mobile() {
