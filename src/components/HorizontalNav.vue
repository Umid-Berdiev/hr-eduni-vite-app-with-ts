<script>
  ...
  export default {
    ...
    mounted() {
      ...
      const matchingMenuItem = links.find(
        (link) => window.location.pathname === link.pathname
      );
      ...
      <div class="d-flex">
        ...
        <div class="navbar-brand-box">
          <router-link to="/" class="logo logo-dark">
            <span class="logo-sm">
              <img
                src="../assets/images/logo-eduni-mini.png"
                alt=""
                height="22"
              />
            </span>
      ...
      <div class="d-flex">
        ...
        <div class="dropdown d-inline-block language-switch">
          ...
          <div class="dropdown-menu dropdown-menu-end">
            ...
            <a
              ...
              class="dropdown-item side-nav-link-ref notify-item language"
              data-lang="uz"
            >
              <img
                src="../assets/images/flags/uz.jpg"
                alt="user-image"
                class="me-1"
                height="12"
              />
        ...
        <div class="dropdown d-inline-block">
          ...
          <div class="dropdown-menu dropdown-menu-end pt-0">
            ...
            <router-link class="dropdown-item" to="/contacts/profile"
              ><i
            ...
            >
            <router-link class="dropdown-item" to="/auth/lock-screen"
              ><i
            ...
            <router-link class="dropdown-item" to="/auth/logout"
              ...
              ></i>
              <span class="align-middle">Logout</span></router-link
            >
          </div>
        </div>
      </div>
